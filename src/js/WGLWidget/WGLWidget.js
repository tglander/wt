...
(1, JavaScriptConstructor, "WGLWidget",
 function(APP, canvas) {
   ...
   this.setLookAtParams = function(matrix, center, up, pitchRate, yawRate) {
		...
		this.getManipulator().setLookFromToUp();
		
		// this.getManipulator().setTarget(center);
		// this.getManipulator().setDistance(20.0);
	...
	this.setLookAtParams = function(matrix, from, center, up) {
		this.setupManipulator();
		// TODO: set up using home position

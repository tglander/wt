...
public:
  ...
  Wt::JSlot clientSideRightKeyDownFcn_;
  Wt::JSlot clientSideLeftKeyDownFcn_;
  Wt::JSlot clientSideUpKeyDownFcn_;
  Wt::JSlot clientSideDownKeyDownFcn_;

...
public:
  ...
  void decrementRotX();
  void decrementRotY();
  void updateLights(macVec3 newAmbientColor,macVec3 newLightDirection,macVec3 newLightColor,macVec3 newSpecColor);
  ...
  void updateBools(bool useLights,bool useColor, bool useSpec);
...
private:
  ...
  UniformLocation useColorMapUniform_ ;
  UniformLocation useSpecularMapUniform_;
  UniformLocation useLightingUniform_;
  UniformLocation ambientColorUniform_;
  UniformLocation pointLightingLocationUniform_;
  UniformLocation pointLightingSpecularColorUniform_;
  UniformLocation pointLightingDiffuseColorUniform_;
  UniformLocation colorMapSamplerUniform_;
  UniformLocation specularMapSamplerUniform_;
  ...
  Texture specMapTextureSrc;
  Texture earthTextureSrc;

...
public:
  ...
  void decrementRotX();
  void decrementRotY();
  void updateLights(macVec3 newAmbientColor,macVec3 newLightDirection,macVec3 newLightColor,macVec3 newSpec,double newShiness);
  ...
  void updateBools(bool,bool,bool);
...
private:
  ...
  UniformLocation showSpecHighLightsUniform_;
  ...
  UniformLocation materialShininessUniform_;
